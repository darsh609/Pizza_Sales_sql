...
-- Joorder_detailsin the necessary tables to find the total quantity of each pizza category ordered.
...
SELECT 
    pizza_types.name, SUM(order_details.quantity) AS quantt
FROM
    pizza_types
        JOIN
